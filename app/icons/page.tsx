  ...
  useEffect(() => {
    ...
    setIconSettings((prev) => {
      const isDefaultColor =
        prev.color === "#ffffff" || prev.color === "#374151";
      if (isDefaultColor) {
                  ...
                  <>
                    ...
                    <div className="absolute right-0 top-12 bg-color-white dark:bg-color-gray-800 rounded-2xl shadow-2xl border border-color-gray-200 dark:border-color-gray-700 p-5 w-[250px] z-50">
                      ...
                      <ControlBar
                        ...
                        onFillChange={(fill) =>
                          handleIconSettingsChange({
                            ...iconSettings,
                            variant: fill ? "fill" : "line",
                          })
                        }
                        color={iconSettings.color}
                        onColorChange={(color) =>
                          handleIconSettingsChange({ ...iconSettings, color })
                        }
                        size={iconSettings.size}
                        onSizeChange={(size) =>
                          handleIconSettingsChange({ ...iconSettings, size })
                        }
